...
<head>
    ...
    <script type="text/javascript" src="<%=basePath %>/app/js/checkUserAddForm.js"></script>
...
<div class="user-content">
    ...
    <form action="/rest/user/register" method="get" id="form1">

        <div class="user-add-infolist">
            <p class="user-add-title">新增用户</p>
            <ul class="add-list">
                <li class="list-item"><label>登录名</label> <input type="text"
                                                                placeholder="只能输入字母和数字，以字母开头" name="loginName"
                                                                maxlength="15" onchange="checklogin_name()"/> <span id="login_name"></span></li>
                ...
                <li class="list-item"><label>角色</label> <select name="role"
                    ...
                    <option value="3" selected>客户管理员</option>
                    ...
                    <div class="xxgl">
                        ...
                        <div class='time'>
                            <div class="begin">
                                开始时间： <input type="" name="mystarttime" id="dt" value=""
                                             readonly="readonly" placeholder="选择日期" />
                                <div id="dd"></div>
                            </div>
                            <div class="end">
                                结束时间： <input type="" name="myendtime" id="dt-b" value=""
                                             readonly="readonly" placeholder="选择日期" />
                                <div id="dd-b"></div>
                            </div>
                        </div>
