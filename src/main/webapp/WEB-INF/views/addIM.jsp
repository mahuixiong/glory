...
<head>
 ...
 <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-13" data-genuitec-path="/glory/src/main/webapp/WEB-INF/views/addIM.jsp" class="" style="height: 310px; width: 1126px;">
						...
						<li class="edittable-top">
							...
							<div class="edittable-right">
								<ul>
									...
									<li>
										<lable>样品编号</lable>
										<input type="" class="ypbh" name="sample_id" placeholder="首字母英文，长度为5-50位" id="" value="" maxlength="50">
										<span id="sample_id"></span>
									</li>
									
									<li>
										<lable>农产品加工原料类别</lable>
										<select class="sel"  name="crop_category_id" id="cptype">
							  ...
							  <input type="hidden" value="" name="county" id="county">
							   <input type="hidden" value="123" id="wsx">
				        		...
				        		<select class="city" id="shi" onblur="checkprovince()" onchange="changeShi(this.value,'shen','shi','xian')">
				        		...
				        		<select class="county" onblur="checkprovince()" id="xian">
									...
									<li>
										<lable>收获时间</lable>
										<input type="" name="harvest_time" id="dt" value="" readonly="readonly" placeholder="选择日期">
									...
									<li>
										<lable>取样时间</lable>
										<input type="" name="sampling_time" id="dt-b" value="" readonly="readonly" placeholder="选择日期">
									...
									<li>
										<lable>取样人</lable>
										<input maxlength="15" placeholder="请输入取样人姓名" >
									...
									<li>
										<lable>真菌污染率</lable>
										<input name="pollution_rate" type="" id="" value="" maxlength="5" placeholder="不需要输入'%'">
	...
	<script type="text/javascript" src="/glory/static/js/linkage4.js"></script>
