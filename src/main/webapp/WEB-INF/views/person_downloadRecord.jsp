...
<head>
	...
	<link rel="stylesheet" href="../../app/css/p_downloadRecord.css" />
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-55" data-genuitec-path="/glory/src/main/webapp/WEB-INF/views/person_downloadRecord.jsp" style="height: 309px; width: 1126px;">
	
	<!--
     		内容顶部路由页显示
        -->
    <p class="top_url_box box" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-55" data-genuitec-path="/glory/src/main/webapp/WEB-INF/views/person_downloadRecord.jsp">
    	<!-- <span>当前页面 ：个人中心/</span><a>下载记录</a>
    	&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: gray;">只能查看最近20条下载记录</span> -->
    <span style="color: green;">只能查看最近20条下载记录</span>
    </p>
   ...
   <article class="article_box box">
    	...
    	<div class="articles_box">
    		<div class="seria_num">
    			...
    			<div class="sample_id">R-13-2322321</div>
    		</div>
    		...
    		<div class="seria_right">
	    		...
	    		<div class="articles_box_nr caozuo sample_info4">
	    			<ul>
	    				...
	    				<li class="showbox">展开 <div style="display: none">20</div><span id="showa"></span></li>
