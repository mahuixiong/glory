...
<head>
    ...
    <script type="text/javascript" src="<%=basePath %>app/js/checkforgetpwd.js" ></script>
</head>
<body>
<div class="contaner">
    <div class="login-box1">
        ...
        <p>
            <font color="white">所有信息输入正确，方可修改密码</font>
        </p>
        ...
        <form action="rest/user/forgetpwd" method="post">
            <div class="loginbox-info1">
            <table>
                <tr>
                    <td class="td1">账号:</td>
                    <td class="td2"><input type="text" name="loginName" class="td2" maxlength="16" onchange="checkloginName()" placeholder="请输入账号"/></td>
                    <td class="td3"><span id="sploginName"></span></td>
                </tr>
                <tr>
                    <td class="td1">用户名:</td>
                    <td class="td2"><input type="text" name="username" class="td2" maxlength="16" onchange="checkusername()" placeholder="输入用户名"/></td>
                ...
                <tr>
                    <td colspan="3" align="center"><input type="button" value="修改" onclick="sub()" class="login-sin"></td>
                </tr>
            </table>
            </div>
            <%--<ul>--%>
